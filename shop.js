(function () {
  var PLANS = {
    pdf: {
      ...
      price: 599,
      label: "599 ден.",
      copy: "Се плаќа само со картичка. По уплатата добиваш потврда и линк за симнување на е-пошта. Линкот останува активен."
    },
    print: {
      id: "print",
    ...
    komplet: {
      ...
      price: 1299,
      label: "1.299 ден.",
      copy: "PDF и печатена верзија на квалитетна хартија. Со картичка добиваш потврда и линк за симнување на е-пошта. На врата, линкот стигнува кога ќе ја подигнеш пратката."
    }
  };
  ...
  function updatePayUI() {
    ...
    if (selected === "komplet") {
      note.textContent = "Плаќаш сега со картичка. На е-пошта стигнува потврда и линк за симнување. Печатената верзија ја праќаме на адреса.";
      return;
    }
